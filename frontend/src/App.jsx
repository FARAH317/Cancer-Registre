...
import NewConsultationPage, { NewEffetIndesirablePage } from './pages/suivi/NewConsultationPage';
  ...
  return (
    <BrowserRouter future={{ v7_relativeSplatPath: true, v7_startTransition: true }}>
      ...
      <Routes>
        ...
        <Route path="/administration" element={<ProtectedRoute><AdminPage /></ProtectedRoute>} />
        <Route path="/suivi/effets/nouveau"        element={<ProtectedRoute><NewEffetIndesirablePage /></ProtectedRoute>} />
