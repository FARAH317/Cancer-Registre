...
class TraitementBase(models.Model):
    ...
    # ── CORRECTION : diagnostic est défini dans chaque sous-classe
    #    avec un related_name explicite pour que prefetch_related
    #    dans diagnostics/views.py fonctionne correctement.
...
class Chimiotherapie(TraitementBase):
    ...
    # ── Lien diagnostic avec related_name explicite ──────────────
    diagnostic = models.ForeignKey(
        Diagnostic,
        on_delete=models.SET_NULL,
        null=True, blank=True,
        related_name='chimiotherapie_set',  # ← CORRECTION
    )
...
class Radiotherapie(TraitementBase):
    ...
    diagnostic = models.ForeignKey(
        ...
        on_delete=models.SET_NULL,
        null=True, blank=True,
        related_name='radiotherapie_set',  # ← CORRECTION
    )
...
class Chirurgie(TraitementBase):
    ...
    diagnostic = models.ForeignKey(
        ...
        on_delete=models.SET_NULL,
        null=True, blank=True,
        related_name='chirurgie_set',  # ← CORRECTION
    )
...
class Hormonotherapie(TraitementBase):
    ...
    diagnostic = models.ForeignKey(
        ...
        on_delete=models.SET_NULL,
        null=True, blank=True,
        related_name='hormonotherapie_set',  # ← CORRECTION
    )
...
class Immunotherapie(TraitementBase):
    ...
    diagnostic = models.ForeignKey(
        ...
        on_delete=models.SET_NULL,
        null=True, blank=True,
        related_name='immunotherapie_set',  # ← CORRECTION
    )
